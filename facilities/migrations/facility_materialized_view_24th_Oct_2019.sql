...
facilities_facility.closed, facilities_facility.is_published, facilities_facility.approved_national_level,
...
LEFT JOIN facilities_facilitytype as facilities_facilitytypecat   ON facilities_facilitytypecat.id = facilities_facilitytype.parent_id
