...
class ApiAuthentication(models.Model):
    username = models.CharField(max_length=255, default=settings.DHIS_USERNAME, null=False, blank=False)
    password = models.CharField(max_length=255, default=settings.DHIS_PASSWORD, null=False, blank=False)
    client_id = models.CharField(max_length=255, default=settings.DHIS_CLIENT_ID, null=False, blank=False)
    client_secret = models.CharField(max_length=255, default=settings.DHIS_CLIENT_SECRET, null=False,
                                     blank=False)
    server = models.CharField(max_length=255, default=settings.DHIS_ENDPOINT, null=False, blank=False)
