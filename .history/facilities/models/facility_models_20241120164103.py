...
def sendDataToOpenHIM(payload, method):
    credentials = f"{username}:{password}"
    auth_coded = base64.b64encode(credentials.encode()).decode("utf-8")


    post_url = "https://interoperabilitylab.uonbi.ac.ke/interop230/khmfr_dhis"
    put_url = "https://interoperabilitylab.uonbi.ac.ke/interop230/khmfr_dhis"
